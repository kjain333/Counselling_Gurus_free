...
class _CollapsingListTileState extends State<CollapsingListTile> {
  ...
  void initState() {
    ...
    widthAnimation = Tween<double>(begin: 220.0, end: 70.0).animate(widget.animationController);
    sizedBoxAnimation = Tween<double>(begin: 10.0, end: 0.0).animate(widget.animationController);
  }
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Icon(widget.icon, color: widget.isSelected ? selectedColor : Colors.white30, size: 25.0,),
