        ...
        children: <Widget>[
          ...
          Container(
            child: Padding(
              ...
              child: Text(
                "Share the Code With Friends to get 500 Credit Points in Your Wallet",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
          ...
          Container(
            child: Text(
              "To check your current credit points , Visit Wallet",
              textAlign: TextAlign.center,
...
// All the Commented lines would be used once app goes live !! , working fine in the testmode at branch dashboard 