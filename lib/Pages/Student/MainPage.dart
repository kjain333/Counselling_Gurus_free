      ...
      return GestureDetector(
        onTap: (){
          if(index==2)
            ...
            Share.share(
                'https://play.google.com/store/apps/details?id=com.counselling_gurus_eng.counselling_gurus',//heading[index-1]
                subject: 'Counselling Gurus JOSAA Counselling App');
          else if(index==3)
            _launchURL("https://play.google.com/store/apps/details?id=com.counselling_gurus_eng.counselling_gurus");
          else if(index==4)
