...
class ScheduleMeetingMentor extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.push(context,MaterialPageRoute(builder: (context)=>ScheduleNewMeetingMentor()));
        },
      ),
...
class ScheduleNewMeetingMentor extends StatefulWidget{
  @override
...
class _ScheduleMeeting extends State<ScheduleNewMeetingMentor>{
