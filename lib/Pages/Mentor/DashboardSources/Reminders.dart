              ...
              trailing: Wrap(
                children: <Widget>[
                  ...
                  IconButton(
                    ...
                    onPressed: (){
                      setState(() {
                        _events.updateAll((key, value){
                          print(_selectedDay);
                          if(key.day==_selectedDay.day&&key.month==_selectedDay.month)
                                            ...
                                            child: RaisedButton(
                                              onPressed: (){
                                                ...
                                                setState(() {
                                                  ...
                                                  _onDaySelected(_selectedDay, _events[_selectedDay]);
                                                });
                                              },
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Text('To-dos',style: GoogleFonts.aBeeZee(color: Colors.redAccent,fontSize: 18,fontWeight: FontWeight.w300),),
            ),
          ),
          Container(
            width: MediaQuery.of(context).size.width,
